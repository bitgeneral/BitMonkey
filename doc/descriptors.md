# Support for Output Descriptors in Bitmonkey Core

Since Bitmonkey Core v0.17, there is support for Output Descriptors. This is a
...
existing Bitmonkey Core wallets, a convenience function `combo` is
