...
"""Verify that starting bitmonkey with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitmonkey with -h for help text")
        ...
        self.log.info("Start bitmonkey with -version for version information")
        ...
        self.log.info("Start bitmonkeyd with -fakearg to make sure it does not start")
