Contributing to Bitmonkey Core
============================

The Bitmonkey Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Bitmonkey Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/bitmonkey-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bitmonkey-qt
...
The following applies to code changes to the Bitmonkey Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bitmonkey
Network Protocol consensus changes.

Whether a pull request is merged into Bitmonkey Core rests with the project merge
...
Patches that change Bitmonkey consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitmonkey consensus, it must have been
...
The project leader is the release manager for each Bitmonkey Core release.
