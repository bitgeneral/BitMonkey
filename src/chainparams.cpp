...
{
    const char* pszTimestamp = "Trump flies like an insect 6/june/2025. Monkeys flies like a banana.";
    const CScript genesisOutputScript = CScript() << ParseHex("04902bda9e9feaa9c7206f8eae4b3ea5f5c1d7fbf77f00971b8ddf275b74650e366a08712058fe4c76e17ea38f99bd1e4e54a451715cbb71398a584fb8c6717b16") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1751778554, 315585, 0x1e0ffff0, 1, 70 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("000008e5c1cdd3d588adfce1375bc50dcee9afdcd3e8f326f32f96582da473b9"));
        assert(genesis.hashMerkleRoot == uint256S("7c29a221d8e00fdafbbc0ca650ff24f27cae8ad1d25d600413e5ff35ef348909"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x02, 0x4F, 0xE4, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x02, 0xB2, 0xAD, 0x58};
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bitmonkeytools.com");
        vSeeds.emplace_back("seed-b.bitmonkey.loshan.co.uk");
